...
var roles = {
  ...
  'Monitoring Contributor': managementGroupResourceId('Microsoft.Authorization/roleDefinitions', '749f88d5-cbae-40b8-bcfc-e573ddc772fa')
  'Monitoring Reader': managementGroupResourceId('Microsoft.Authorization/roleDefinitions', '43d0d8ad-25c7-4714-9337-8ba259a9fe05')
...
var roleDefinitionId = contains(roles, role) ? roles[role] : managementGroupResourceId('Microsoft.Authorization/roleDefinitions', role)

// ---------
// RESOURCES
// ---------

resource group 'Microsoft.Management/managementGroups@2021-04-01' existing = {
  scope: tenant()
  name: resourceName
}
...
resource rbac 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(toLower(group.id), toLower(principalId), toLower(roleDefinitionId))
  properties: {
